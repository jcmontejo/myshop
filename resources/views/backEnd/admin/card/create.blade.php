@extends('backLayout.app') @section('title') Crear Nueva Tarjeta @stop @section('content')

<div class="box">
    <div class="box-header">
        <h3 class="box-title">Crear Nueva Tarjeta</h3>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
        ...
        <div class="form-group {{ $errors->has('image') ? 'has-error' : ''}}">
            ...
            <div class="col-sm-6">
                {!! Form::file('image', null, ['class' => 'input-lg form-control', 'required' => 'required']) !!} {!! $errors->first('image', '
                <p
                    class="help-block">:message</p>') !!}
            </div>
        </div>
